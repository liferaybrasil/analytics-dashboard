...
var _metalJsx = __webpack_require__(5);
...
var Dashboard = function (_JSXComponent) {
    ...
    _createClass(Dashboard, [{
        ...
        value: function render() {
            ...
            IncrementalDOM.elementOpen('div', null, null, 'class', 'col-sm-6');
            IncrementalDOM.elementVoid(_components.Card, null, null, 'title', 'Workflows', 'icon', 'my icon', 'number', '9');
            IncrementalDOM.elementVoid(_components.Card, null, null, 'title', 'Published', 'icon', 'my icon', 'number', '7');
            IncrementalDOM.elementVoid(_components.Card, null, null, 'title', 'Unpublished', 'icon', 'my icon', 'number', '2');
            IncrementalDOM.elementClose('div');
            IncrementalDOM.elementOpen('div', null, null, 'class', 'col-sm-6');
            IncrementalDOM.text('column2');
            IncrementalDOM.elementClose('div');
            IncrementalDOM.elementClose('div');
            IncrementalDOM.elementClose('div');
...
exports.Footer = exports.Card = exports.Header = undefined;
...
var CardIcon = function (_JSXComponent) {
    ...
    _createClass(CardIcon, [{
        ...
        value: function render() {
            ...
            iDOMHelpers.renderArbitrary(this.props.icon);
            return IncrementalDOM.elementClose('div');
        }
    }]);
